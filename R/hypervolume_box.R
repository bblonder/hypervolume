hypervolume_box <- function(data, name=NULL, verbose=TRUE, samples.per.point=ceiling((10^(2+sqrt(ncol(data))))/nrow(data)), kde.bandwidth=2*estimate_bandwidth(data), tree.chunksize=1e4)
{
  data <- as.matrix(data)
