...
public:
  ...
  /**
  * A pointer back to the structure data of input points, 
...
class KDTree {
  ...
  private: vector<vector<double> > points;    // vector<double>s data
      ...
      private: int ndim;                // Data dimensionality
        private: int npoints;             // Number of points
          private: vector<int>   workarray; // Used in tree construction
            ...
            private: vector<double> Bmin;  		 	  // bounding box lower bound
              private: vector<double> Bmax;  		      // bounding box upper bound
                                ...
                                private: void linear_tree_print(){
                                  ...
                                  */ 
                                  public: void left_depth_first_print( int nodeIdx = 0 ){
                                    ...
                                    * 
                                    */
                                    public: void k_closest_points(const vector<double>& Xq, int k, vector<int>& idxs, vector<double>& distances){
                                      ...
                                      private: void leaves_of_node( int nodeIdx, vector<int>& indexes ){
                                        ...
                                        * @article{friedman1977knn,
                                                   ...
                                                   */
                                        private: void knn_search( const vector<double>& Xq, int nodeIdx = 0, int dim = 0){
                                          ...
                                          */
                                          private: bool ball_within_bounds(const vector<double>& Xq){
                                            ...
                                            * 
                                            */
                                            private: double bounds_overlap_ball(const vector<double>& Xq){
                                              ...
                                              public: int closest_point(vector<double> p){
                                                // search closest leaf
                                                ...
                                                */
                                                private: void check_border_distance(int nodeIdx, int dim, vector<double> pnt, double& cdistsq, int& idx){
                                                  Node* node = nodesPtrs[ nodeIdx ];
                                                  ...
                                                  */
                                                  public: void ball_query( const vector<double>& point, const double radius, vector<int>& idxsInRange, vector<double>& distances ){
                                                    // create pmin pmax that bound the sphere
                                                    vector<double> pmin(ndim,0);
                                                    vector<double> pmax(ndim,0);
                                                    ...
                                                    */
                                                    public: void ball_bbox_query(int nodeIdx, vector<double>& pmin, vector<double>& pmax, vector<int>& inrange_idxs, vector<double>& distances, const vector<double>& point, const double& radiusSquared, int dim=0){
                                                      Node* node = nodesPtrs[nodeIdx];
                                                      ...
                                                      * 
                                                      */
                                                      public: void range_query( const vector<double>& pmin, const vector<double>& pmax, vector<int>& inrange_idxs, int nodeIdx=0, int dim=0 ){
                                                        Node* node = nodesPtrs[nodeIdx];
